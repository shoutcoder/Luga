    ...
    <div>
      <div className="flex justify-between bg-white text-white py-2">
              ...
              <div className="flex items-center justify-between gap-3 px-4 md:px-16">
                ...
                <div className="hidden md:flex items-center space-x-2">
                  ...
                  <p className="text-black text-xs">
                    <Link href="mailto:hei@luga.no">hei@luga.no</Link>
                  </p>
                </div>
              </div>
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-6 text-white">
          ...
          <Link href="https://repair.vandre.no/Luga/repair?language=no" className="text-sm font-medium bg-white text-black px-8 py-2 rounded hover:bg-gray-200 hover:text-black transition">
            Bestill
          </Link>
          <Role />
        </div>
